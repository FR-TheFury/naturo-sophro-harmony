    ...
    <Layout>
      ...
      <section className="relative py-24 md:py-32 overflow-hidden">
        ...
        <div className="container-custom mx-auto px-4 md:px-8 text-center relative z-10">
          ...
          <h2 className="text-title text-primary-foreground mb-6 max-w-3xl mx-auto text-balance">
        ...
        <div className="container-custom mx-auto px-4 md:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={value.title}
                className="group text-center p-8 rounded-3xl bg-card border border-border/40 transition-all duration-500 hover:-translate-y-2 hover:shadow-organic"
              >
